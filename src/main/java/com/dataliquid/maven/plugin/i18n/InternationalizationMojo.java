package com.dataliquid.maven.plugin.i18n;
...
import com.dataliquid.maven.plugin.i18n.io.Escaping;
import com.dataliquid.maven.plugin.i18n.io.OutputFormat;
import com.dataliquid.maven.plugin.i18n.io.ResourceReader;
import com.dataliquid.maven.plugin.i18n.io.ResourceWriter;
...
public class InternationalizationMojo extends AbstractMojo {
    ...
    /**
     * Override escaping method for special characters when writing resources All
     * defaults can be overriden with the <code>escaping</code> parameter.
     *
     * @see #escaping
     */
    ...
    /**
     * Overrides the default escaping method for add formats. Supported values:
     * <br/>
     * <code>NONE</code><br/>
     * <code>JAVA</code> <br/>
     * <code>HTML</code><br/>
     ...
     * properties: JAVA<br/>
     * json: NONE<br/>
     * xml: NONE For custom overrides use the <code>escapings</code> map.
     *
     * @see #escapings
     */
